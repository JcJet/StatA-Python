...
class DataHandler(object):
    ...
    This will replicate how a live strategy would function as current market data would be sent "down the pipe". Thus a historic and live
...
class HistoricCSVDataHandlerHFT(DataHandler):
    ...
    and provide an interface to obtain the "latest" bar in a manner identical to a live trading interface. 
    """
    ...
    def _open_convert_csv_files(self):
        ...
        for s in self.symbol_list:
            ...
            self.symbol_data[s] = pd.io.parsers.read_csv(
                ...
                header=0, index_col=0, parse_dates={'datetime':['date', 'time']},
                names=['date', 'time', 'open', 'high', 'low', 'close', 'volume']).sort_index()
