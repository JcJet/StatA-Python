...
class Portfolio(object):
    ...
    The holdings DataFrame stores the cash and total market holdings value of each symbol 
    for a particular time-index, as well as the percentage change in portfolio total across bars. 
    """
    def __init__(self, bars, events, start_date, initial_capital=100000.0):
        ...
        Parameters: 
        bars - The DataHandler object with current market data. e
        vents - The Event Queue object. 
    ...
    def update_timeindex(self, event):
        ...
        dh['comission'] = self.current_holdings['comission']
    ...
    def update_holdings_from_fill(self, fill):
        ...
        self.current_holdings['cash'] -= (cost + fill.comission)
        self.current_holdings['total'] -= (cost + fill.comission)
