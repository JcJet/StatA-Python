"""
class structure ideas from the book "Successful Algorithmic Trading, M.L. Halls-Moore
"""
class Event(object):
    """
...
class OrderEvent(Event):
    """
    Handles the event of sending an Order to an execution system. The order contains a symbol (e.g. GOOG), a type (market or limit),
